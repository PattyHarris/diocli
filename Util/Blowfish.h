...
// Diomede: Blowfish specfic exceptions for cross platform 
// exception handling.
class CBlowFishException : public std::exception 
{
private:
	std::string			m_szMessage;
public:
	CBlowFishException(std::string szMessage) {
        m_szMessage = szMessage;
	}
	
	virtual const char* what() const throw() { return m_szMessage.c_str(); }
	
	~CBlowFishException() throw() { }
