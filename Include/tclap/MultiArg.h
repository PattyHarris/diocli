 ...
 */
template<class T>
std::string MultiArg<T>::longID(const std::string& val, const bool& bShowName /*false*/ ) const
{
	std::string id = Arg::longID(_typeDesc, bShowName) + "  (accepted multiple times)";
