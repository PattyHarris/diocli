...
class UnlabeledMultiArg : public MultiArg<T>
{
	...
	public:
		 ...
		 */
		UnlabeledMultiArg( CmdLineInterface* cmdOwner,
...
template<class T>
UnlabeledMultiArg<T>::UnlabeledMultiArg(CmdLineInterface* cmdOwner,
		                                const std::string& name,
				                        const std::string& desc,
										bool req,
					                    const std::string& typeDesc,
 ...
 */
template<class T>
void UnlabeledMultiArg<T>::resetArg()
{
    _alreadySet = false;
}
 ...
 */
template<class T>
void UnlabeledMultiArg<T>::resetValue()
{
    T val;
	_value = val;
}
...
template<class T>
std::string UnlabeledMultiArg<T>::longID(const std::string& val,
                                         const bool& bShowName /*false*/ ) const
{
