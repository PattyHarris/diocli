...
class UnlabeledValueArg : public ValueArg<T>
{
	...
	public:
		 ...
		 */
		UnlabeledValueArg( CmdLineInterface* cmdOwner,
 ...
 */
template<class T>
UnlabeledValueArg<T>::UnlabeledValueArg(CmdLineInterface* cmdOwner,
                                        const std::string& name,
					                    const std::string& desc,
										bool req,
					                    T val,
 ...
 */
template<class T>
void UnlabeledValueArg<T>::resetArg()
{
    _alreadySet = false;
}
 ...
 */
template<class T>
void UnlabeledValueArg<T>::resetValue()
{
    T val;
	_value = val;
}
 ...
 */
template<class T>
std::string UnlabeledValueArg<T>::longID(const std::string& val,
                                         const bool& bShowName /*false*/ ) const
{
