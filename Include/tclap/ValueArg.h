 ...
 */
template<class T>
std::string ValueArg<T>::longID(const std::string& val, const bool& bShowName /*false*/ ) const
{
    return Arg::longID( _typeDesc, bShowName );
}
